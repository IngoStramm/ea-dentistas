let map,marker,lat,lng,autocomplete;const allInfoWindows=[],markers={},itemsLista=Object.values(ajax_object.listagem),itemsDestaques=itemsLista.filter(e=>"on"===e.destaque),itensNaoDestaques=itemsLista.filter(e=>"on"!==e.destaque),todosDentistas=itemsLista;function removeAccents(e){return e.normalize("NFD").replace(/[\u0300-\u036f]/g,"")}lat=ajax_object.lat,lng=ajax_object.lng;const estadoUsuario=ajax_object.estado?removeAccents(ajax_object.estado.toUpperCase()):"",cidadeUsuario=ajax_object.cidade?removeAccents(ajax_object.cidade.toUpperCase()):"",cepUsuario=ajax_object.cep?ajax_object.cep.replace(/\D/g,""):"",bairroUsuario=ajax_object.bairro?removeAccents(ajax_object.bairro.toUpperCase()):"";function closeAllInfoWindows(){for(const e of allInfoWindows)e.close()}function btnClick(t,o){t.addEventListener("click",e=>{e.preventDefault(),closeAllInfoWindows();e=t.dataset.markerid;o.maps.event.trigger(markers[e],"click")})}function initGoogleApi(){document.addEventListener("DOMContentLoaded",function(){eaDentistasListagem(),initAutocomplete()})}function initMap(){var e,t=document.getElementById("map");t&&(lat,lat&&(lng,lng)||(lat="-23.5502909",lng="-46.6341887"),lat=Number(lat),lng=Number(lng),e={lat:lat,lng:lng},map=new google.maps.Map(t,{zoom:15,center:e,mapTypeControl:!1}),todosDentistas.forEach((e,t)=>{var o={lat:parseFloat(e.lat),lng:parseFloat(e.lng)};const a=`<div>
            ...
            </div>`,n=new google.maps.InfoWindow({content:a,ariaLabel:e.nome_fantasia});allInfoWindows.push(n);var l,o=new google.maps.Marker({position:o,map:map,title:e.nome_fantasia});google.maps.event.addListener(o,"click",(l=o,function(){closeAllInfoWindows(),n.setContent(a),n.open(map,l),map.setZoom(16),map.setCenter(l.getPosition())})),markers[e.post_id]=o}))}function initAutocomplete(){var e=document.getElementById("autocomplete");e&&(autocomplete=new google.maps.places.Autocomplete(e,{componentRestrictions:{country:["BR"]},fields:["place_id","geometry","name","address_components"]}),e.addEventListener("change",e=>{var t=document.getElementById("ea-autocomplete-form-btn"),o=document.getElementById("autocomplete-message");t?o?(o.style.display="block",t.setAttribute("disabled","")):console.error("Não foi possível encontrar a <div> de alerta de mensagens."):console.error("Não foi possível encontrar o botão de envio do formulário")}),autocomplete.addListener("place_changed",onPlaceChanged))}function onPlaceChanged(){var e,t,o,a=autocomplete.getPlace(),n=document.querySelector(".ea-autocomplete-form"),l=n.querySelector('input[name="lat"]'),r=n.querySelector('input[name="lng"]'),s=n.querySelector('input[name="estado"]'),i=n.querySelector('input[name="cidade"]'),c=n.querySelector('input[name="cep"]'),u=n.querySelector('input[name="bairro"]'),d=document.getElementById("ea-autocomplete-form-btn"),p=document.getElementById("autocomplete-message");d&&d.setAttribute("disabled",""),p&&(p.style.display="block"),n?l?r?s&&i?c?u?a.geometry?(lat=a.geometry.location.lat(),lng=a.geometry.location.lng(),n=a.address_components.filter(e=>e.types.includes("administrative_area_level_1")),e=a.address_components.filter(e=>e.types.includes("administrative_area_level_2")),t=a.address_components.filter(e=>e.types.includes("postal_code")),o=a.address_components.filter(e=>e.types.includes("sublocality_level_1")),document.getElementById("autocomplete").innerHTML=a.name,l.value=lat,r.value=lng,s.value=n[0]?.short_name,i.value=e[0]?.short_name,c.value=t[0]?.short_name,u.value=o[0]?.short_name,p.style.display="none",d.removeAttribute("disabled")):(document.getElementById("autocomplete").placeholder="Digite um endereço",l.value="",r.value="",s.value="",i.value="",c.value="",u.value="",p.style.display="block",d.setAttribute("disabled","")):console.error("Não foi possível encontrar o input de bairro"):console.error("Não foi possível encontrar o input de CEP"):console.error("Não foi possível encontrar o input de Estado"):console.error("Não foi possível encontrar o input de longitude"):console.error("Não foi possível encontrar o input de latitude"):console.error("Não foi possível encontrar o formulário do autocomplete")}function addPageNumbers(t,o,a,n,l){var r=Number(o.querySelector('input[name="current-page"]').value);for(let e=1;e<=a;e++){var s=document.createElement("li"),i=(s.classList.add("page-number"),r===e&&s.classList.add("current"),document.createElement("button"));i.innerText=e,i.dataset.pageIndex=e,s.append(i),t.append(s),changeCurrentPage(i,n,l,t,o)}}function setCurrentPage(e,t,o){var a=Number(t.querySelector('input[name="current-page"]').value)*o,n=a-o;let l=1;for(const r of e)l<=n||l>a?r.style.display="none":r.style.display="",l++}function changeCurrentPage(n,l,r,s,i){n.addEventListener("click",t=>{t.preventDefault();var t=i.querySelector('input[name="current-page"]'),o=Number(n.dataset.pageIndex),e=n.parentElement;if(e&&!e.classList.contains("current")){t.value=o;let e=1;for(const a of s.querySelectorAll(".page-number"))a.classList.remove("current"),e===o&&a.classList.add("current"),e++;setCurrentPage(l,i,r)}})}function eaPaginationPrevNext(e,t,o,a,n){e.addEventListener("click",e=>{e.preventDefault();var e=Number(n.querySelector('input[name="current-page"]').value),t=a.querySelectorAll(".page-number");e<=1||t[e-2].querySelector("button").click()}),t.addEventListener("click",e=>{e.preventDefault();var e=Number(n.querySelector('input[name="current-page"]').value),t=a.querySelectorAll(".page-number");t.length<=e||t[e].querySelector("button").click()})}function eaDentistasPagination(e){for(const r of document.querySelectorAll(".pagination-list")){var t=e.length,t=Math.ceil(t/10),o=r.parentElement.querySelector(".pagination-container");if(!o)return;var a=o.querySelector(".pagination-numbers");if(!a)return;var n=o.querySelector(".pagination-prev"),l=o.querySelector(".pagination-next");addPageNumbers(a,o,t,e,10),setCurrentPage(e,o,10),eaPaginationPrevNext(n,l,e,a,o)}}function eaDentistasGetGeolocation({lat:t,lng:o}){navigator.geolocation.getCurrentPosition(function(e){return t=e.coords.latitude,o=e.coords.longitude,{lat:t,lng:o}},function(e){console.log("Erro:",e)})}function eaDentistasListagem(){var e=document.getElementById("listagem-items");if(e){e=new List("lista-dentistas",{valueNames:["nome","endereco_completo","telefone_contato","destaque","cep","bairro"],page:10,pagination:[{paginationClass:"pagination-top",innerWindow:2,outerWindow:2,item:"<li><a class='page'></a></li>"},{paginationClass:"pagination-bottom",innerWindow:2,outerWindow:2,item:"<li><a class='page'></a></li>"}],item:function(a){return`
