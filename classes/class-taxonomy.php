...
class EA_DENTISTAS_Taxonomy
{
    ...
    protected function labels()
    {
        $default = array(
            ...
            'add_or_remove_items'        => sprintf(__('Add or Remove %ss', 'ea-dentistas'), $this->name),
            ...
            'parent_item'                => sprintf(__('Parent %s:', 'ea-dentistas'), $this->name),
            ...
            'new_item_name'              => sprintf(__('New %s', 'ea-dentistas'), $this->name),
            'all_items'                  => sprintf(__('All %ss', 'ea-dentistas'), $this->name),
            'separate_items_with_commas' => sprintf(__('Separate %ss with comma', 'ea-dentistas'), $this->name),
            'choose_from_most_used'      => sprintf(__('Choose from %ss most used', 'ea-dentistas'), $this->name)
        );
