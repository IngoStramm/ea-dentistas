...
- EA Dentistas (Nome do plugin)
- ea-dentistas (nome dos arquivos, nome do text domain e slug da url do repositório)
- EA_DENTISTAS_ (prefixo usado nas constantes de Url e diretório do plugin, além das classes)
- ea_dentistas_ (prefixo usado nas funções)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do EA Dentistas, através do próprio sistema de atualizações do WordPress
